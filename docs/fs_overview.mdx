...
## A brief outline of our Flight Software
...
The Flight Software begins by starting the [**Supervisior**](fs_mcl.mdx), an endlessly running loop that overlooks all the code
onboard the rocket. The Supervisior creates the [**Registry**](fs_mcl.mdx), in which we store all our data, and initalizes the 
